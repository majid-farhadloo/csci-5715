...
function geo_success(position)
{
	...
	if(position.coords.accuracy<=min_accuracy)
	{
			...
			geoinfo_string="<br/>" + string_head +"Current position: lat=" + position.coords.latitude + ", long=" + position.coords.longitude +  " (accuracy " + position.coords.accuracy +  "m) <br/>last reading taken at: "+ current_time;
		
	}
	else
		geoinfo_string="Accuracy not sufficient ("+Math.round(position.coords.accuracy, 1)+"m vs "+min_accuracy+"m) - last reading taken at: "+current_time;
